function [seq] = prep_Seqloop_IR(seq, params, RF, Grad, ADC, Delay, Label, sys)
    ...
    function addReadoutBlock(isli, nSlice, TRfill_end, delayETrain)
        ...
        for iexcit = (1-nDummy):nExcit 
            ...
            switch lower(IRMode)
                ...
                case 'sequential'
                    ...
                    for idx = 1:nSlice
                        isli = idx;
                        addReadoutBlock(isli, nSlice, TRfill_end, delayETrain);
                    end
            end
        end
