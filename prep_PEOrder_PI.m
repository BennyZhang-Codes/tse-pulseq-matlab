% function [PEorder, PElabel, phaseAreas, nExcit, pe_full, pe_Img, pe_Ref, pe_ImgAndRef] = prep_PEOrder_PI(PEMode, nY, nEcho, TEeff, TE1, deltak, R, RefLinesRatio)
function [PEorder, PElabel, phaseAreas, nExcit, pe_full, pe_Img, ...
          pe_Ref, pe_ImgAndRef] = prep_PEOrder_PI(PEMode, nY, nEcho, TEeff, ...
          TE1, deltak, R, RefLinesRatio)
